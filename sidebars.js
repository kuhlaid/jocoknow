  ...
  mainNav: [
    {
      ...
      link: {
        ...
        title: 'User Guide',
        description: 'If you are using or plan to use a JoCoKnow to host data but need some help learning how to load, manage and find data in the JoCoKnow, then this is the documentation for you.',
    ...
    },
    {
      ...
      link: {
        type: 'generated-index',
        title: 'Admin Guide',
        description: 'If you are an administrator or plan to be one for a JoCoKnow, then this is the documentation will help you learn the basics of managing your JoCoKnow.',
